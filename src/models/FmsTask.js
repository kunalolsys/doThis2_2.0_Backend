...
const FmsTaskSchema = new mongoose.Schema({
  ...
  frequency: {
    ...
    enum: [
      ...
      'Start+X in days', 'Start+X in hours', 'Start-X in days', 'Start-X in hours',
      'D+X', 'D-X',
      'Task+X in days', 'Task+X in hours', 'Task-X in days', 'Task-X in hours',
      'Event+X in days', 'Event+X in hours', 'Event-X in days', 'Event-X in hours'
    ],
    required: true
  },
  xValue: {
